    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <span className="text-red-700 text-xs font-mono">01.</span>
            <span
              className="text-white font-Text2 text-sm sm:text-base
             hover:text-red-700 hover:cursor-pointer duration-300"
            >
              About
            </span>
          </Link>
          <Link
            ...
            className="flex flex-col text-center space-y-2"
          >
            <span className="text-red-700 text-xs font-mono hover:cursor-pointer">02.</span>
            <span
              className="text-white font-Text2 text-sm sm:text-base
             hover:text-red-700 hover:cursor-pointer duration-300"
            >
          ...
          <Link
            ...
            className="flex flex-col text-center space-y-2"
          >
            <span className="text-red-700 text-xs font-mono">03.</span>
            <span
              className="text-white font-Text2 text-sm sm:text-base
             hover:text-red-700 hover:cursor-pointer duration-300"
            >
          ...
          <Link
            ...
            className="flex flex-col text-center space-y-2"
          >
            <span className="text-red-700 text-xs font-mono">04.</span>
            <span
              className="text-white font-Text2 text-sm sm:text-base
             hover:text-red-700 hover:cursor-pointer duration-300"
            >
          ...
          <a href={"resume/resume.pdf"} target={"_blank"} rel="noreferrer">
           ...
           hover:bg-ResumeButtonHover py-2 sm:py-4 px-5 sm:px-10 text-xs text-red-700"
            >
              Resume
            </button>
          </a>
