...
//         <ArrowIcon className={"flex-none h-5 md:h-6 w-5 md:w-5 translate-y-[2px] text-red-700"} />
//         <div className="flex-none flex-row space-x-2 items-center pr-2">
//           <span className="text-red-700 font-sans text-sm  sm:text-xl"> 03.</span>
...
//                 <span className="text-red-700 text-base">ENS Vision </span>
//                 <a href="https://ens.vision" target="_blank" rel="noopener noreferrer">
//                   <span className=" md:text-gray-200 text-red-700 font-bold text-xl hover:cursor-pointer">
...
//                   At <span className="text-red-700">ENS Vision</span>, I played a crucial role in developing web3
//                   components for their <span className="text-red-700">web3 application</span> using Next.js and web3
//                   libraries. Our focus was on integrating new features and improving the user interface. One notable
//                   achievement was the release of NameWrapper with <span className="text-red-700">ERC72</span>{" "}
//                   support, enabling users to create <span className="text-red-700">subdomains</span>. This showcased
...
//                 <span className="text-red-700 text-base">Recent Project</span>
...
//                   project, including the <span className="text-red-700"> design</span> and implementation of the{" "}
//                   <span className="text-red-700"> smart contract</span> and{" "}
//                   <span className="text-red-700"> blockchain technology</span>. Here i share with you{" "}
//                   <span className="text-red-700"> YPredict - v1 </span> for the private sale.
//                 </p>
//               </div>
//               <ul
//                 className="flex flex-wrap w-full text-gray-300 md:text-gray-400
...
//               <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
//                 <p className="text-gray-300 md:text-gray-400 text-left md:text-right">
//                   This project aim to help you to improve your <span className="text-red-700"> typing </span> by
//                   tracking your progress in <span className="text-red-700"> each round</span> and give you a{" "}
//                   <span className="text-red-700"> score</span> based on your typing speed and accuracy through a
//                   table of <span className="text-red-700"> statistics</span>.
//                 </p>
//               </div>
//               <ul
//                 className="flex flex-wrap w-full text-gray-300 md:text-gray-400
...
//                   <span className="text-red-700">IP Address</span>,{" "}
//                   <span className="text-red-700">{","} software, Hardware</span> and some additional information
...
//                 <span className="text-red-700 text-xl">In initiation...</span>
//               </div>
...
//               <span className="text-red-700 sm:text-lg bg-AAprimary px-2 py-1 rounded">In initiation...</span>
//             </div>
//             <div
//               className="px-8 pt-8 sm:pt-12 md:py-0 xl:col-span-6 xl:col-start-7 col-start-5 
...
//               <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
//                 <p className="text-gray-300 md:text-gray-400 text-left md:text-right">
//                   It&apos; a barber shop <span className="text-red-700">appointment scheduling</span> & management
//                   software it provides <span className="text-red-700">online scheduling</span>, appointment
//                   reminders, <span className="text-red-700">payments</span>, marketing, and much more! Currently in
//                   the <span className="text-red-700">Initiation phase</span>.
//                 </p>
//               </div>
//               <ul
//                 className="flex flex-wrap w-full text-gray-300 md:text-gray-400
...
//               <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
//                 <p className="text-gray-300 md:text-gray-400 text-left ">
//                   A <span className="text-red-700">JavaFX call center management system</span> project it is used
